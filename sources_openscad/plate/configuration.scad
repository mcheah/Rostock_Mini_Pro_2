...
smooth_rod_length=750;  				// determins vertical build height with 508 for 8" 
...
tower_radius = 176.65125712828054705002952581722;
rod_length=printbed[0]*1.2;

corner_radius=12;
//frame_radius=(tower_radius-rod_diameter/2-corner_radius)/cos(30);
//frame_radius=((500-24)*sqrt(3))/3.3
frame_radius=262.43194054073898386779490022816;