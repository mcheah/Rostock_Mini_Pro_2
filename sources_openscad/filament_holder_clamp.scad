...
th2=8;
hull(){
color("blue") translate([0,-(w)/2,6/2]) cube([30+16,w,6],center=true);
groundplate(6);
}
color("blue") translate([0,-(w-6/2),-th/2]) cube([30+16,6,th],center=true);
color("green")
translate([0,0,-(th+th2)])
difference() {
hull(){
color("blue") translate([0,-(w)/2,th2/2]) cube([30+16,w,th2],center=true);
groundplate(th2);
}
#translate([0,-10,th2-2.5/2]) cube([12,12,2.6],center=true);
translate([0,-10,th2-4/2+0.1])
rotate([180,0,0])
#screw_M5(20);
translate([0,-10,th2-4/2-3.0])
rotate([180,0,0])
#screw_M5(20);
}
}
